...
# Before the quotation marks "" we add the letter f and inside the string, 
# wherever we put curly braces {} it will insert the value of what is written inside it.